        ...
        <>
          <div className="dashboard-container">
            ...
            <div className="dashboard-contents">
              <div className="welcome-text" id="items">
                <h2>Welcome back Sheshan !</h2>
              </div>
              <div className="plan" id="items">
                <h4>Plan | Freemium</h4>
              </div>
              <div className="current-weight" id="items">
                <p>Your current weight is 77 Kg</p>
              </div>
              <div className="current-height" id="items">
                <p>Your current height is 176 cm</p>
              </div>
